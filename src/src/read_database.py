...
def get_freq_range():
    ...
    """
    fstart = get_freq_value("Enter the minimum value of the frequency range (in MHz): ")
    fstop = get_freq_value("Enter the maximum value of the frequency range (in MHz): ")
    fres = get_freq_value("Enter the resolution of the frequency (in MHz): ")
